...
| --- | --- | --- | --- |
| `charm.land/bubbles/v2` | `v2.2.0` | MIT | `LICENSE` |
...
| `github.com/alecthomas/chroma/v2` | `v2.14.0` | MIT | `COPYING` |
...
| `github.com/dlclark/regexp2` | `v1.11.0` | MIT | `LICENSE` |
...
- Chroma's `README.md` and `doc.go` identify Pygments-derived lexers/styles;
  regexp2's `README.md` identifies a .NET port and Go regex borrowing. The table
  reports their shipped root licenses, not independent clearance of every
